...
module.exports = {
  ...
  MENU_URL: process.env.MENU_URL || "https://imgur.com/a/zKmBzuM",
  CAPTION: process.env.CAPTION || "ANNSUN-Y",
  READ_MSG: toBool(process.env.READ_MSG),
  OWNER_NAME: process.env.OWNER_NAME || "ANNSUN-Y",
  BOT_NAME: process.env.BOT_NAME || "ANNSUN-Y-𝚅3",
  SUDO: process.env.SUDO || null,
  LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || "Izumi-v3,❤️",
  AUDIO_DATA: process.env.AUDIO_DATA || "Eʏᴘᴢ;Iᴢᴜᴍɪ-ᴠ3;https://imgur.com/a/zKmBzuM",
  PROCESSNAME: process.env.PROCESSNAME || "ANNSUN-Y V3",
